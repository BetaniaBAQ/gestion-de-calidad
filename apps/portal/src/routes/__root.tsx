...
import {
  ...
  DropdownMenuTrigger,
} from '@cualia/ui/components/dropdown-menu'
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
const NAV_ITEMS: readonly NavItem[] = [
  ...
  { to: '/seguridad-paciente', label: 'Seguridad Paciente', icon: Shield },
...
const PAGE_HEADERS: Record<string, { title: string }> = {
  ...
  '/proveedores': { title: 'Proveedores y Terceros' },
  '/seguridad-paciente': { title: 'Seguridad del Paciente' },
